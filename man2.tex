...
%%%%%%%%%%% ____WORK EXPERIENCE___ %%%%%%%%%%%
 ...
 $\circ$ I was assigned the role of Operations and Maintenance engineer in C \& I division
\end{itemize}
...
$\circ$ Wrote a bash script to automate user maintenance for the lab users.
...
$\circ$ As the captain I was responsible for maintaining the discipline and decorum in the school.
 \end{itemize}
